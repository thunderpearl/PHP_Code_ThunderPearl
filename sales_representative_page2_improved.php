...
<!DOCTYPE html>
<!--This page is for updating the customer's info like "sales representative" assigned, "status" and "stage" of application.-->
        ...
        error_reporting(E_ALL);
                ...
                function test_input($data) 
                {
                    ...
                    return $data;
                       ...
                       // $_POST['id'] will collect the data from field by reference.    
                        if(!empty($_POST['id']))
                        {
			...
			// This query is to update the table regarding the status, stage and sales_representative	
           $sql = "UPDATE kuldeep_singh_property_table SET Sales_Representative = '$salesrep', Status = '$status', Stage = '$stages' WHERE id = '$id' ";
           // echo $sql;  
                    
                if (mysqli_query($conn, $sql)) 
                    {
                        echo "Status and stages have been updated <br>";
