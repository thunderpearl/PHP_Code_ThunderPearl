        ...
        <div id="userdata">
            ...
            <form method ="POST" action ="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
               ...
               <label for="uname"> Username:</label>
                <div class="line"><input type="text" name="uname" id="uname" placeholder="Enter Username" required="required"/></div>
                <pre></pre>

                <!--This "required" field will prompt on the first unfilled field not on all if all are vacant -->
                <label for="pass">Password:</label>
                <div class="line"><input type="password" name="pass" id="pass" placeholder="Enter Password" required="required"/></div>
                <pre></pre> 
		...
		if($_SERVER['REQUEST_METHOD'] == "POST")
			{
                error_reporting(E_ALL);
                 ...
                 $username = "root";
                 $password = "secret";
                 $dbname = "userdata";  /* Delibrately didn't give the details here*/
