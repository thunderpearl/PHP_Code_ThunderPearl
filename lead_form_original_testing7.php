...
<html>
<head>
    <link type = "text/css" rel = "stylesheet" href = "http:\\localhost:8080\\lead_form_original7.css"/>
...
<?php 
 if(isset($_POST['fetch_data'])){
  ...
  $id=$_POST['id'];
   $sqluname_retire = "SELECT * from kuldeep_singh_leadform_table where id = '$id'";
...
<div id="form" >
    ...
    <form method = "POST" action ="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"> 
        ...
        <input class = "line" type="text" name="sale or rent" id="sare" placeholder="Property Req. for" value = "<?php if(isset($fetch_data['Property_Req_ON'])!=NULL && $fetch_data['Property_Req_ON']!=''){echo $fetch_data['Property_Req_ON']; }?>" required="required" style="text-align:left"/>
        
        <br>
        <br>
        <!--This field is for the type of property required-->
        <label for="state" class="names">Type of Property Required :</label>
        <input class = "line" type="text" name="proptype" id="proptype" placeholder="Type of Prop. Req." value = "<?php if(isset($fetch_data['Type_of_Property'])!=NULL && $fetch_data['Type_of_Property']!=''){echo $fetch_data['Type_of_Property']; }?>" required="required" style="text-align:left"/>
        ...
        <input class = "line" type="text" name="state" id="state" placeholder="State" value = "<?php if(isset($fetch_data['Prefered_State'])!=NULL && $fetch_data['Prefered_State']!=''){echo $fetch_data['Prefered_State']; }?>" required="required" style="text-align:left"/>
        
        
        <label for="City" class="names"> City:</label>
        <input class = "line" type="text" name="City" id="City" placeholder="City" value = "<?php if(isset($fetch_data['Prefered_City'])!=NULL && $fetch_data['Prefered_City']!=''){echo $fetch_data['Prefered_City']; }?>" required="required" style="text-align:left"/>
        
        
        <label for="Budget" class="names"> Budget:</label>
        <input class = "line" type="text" name="budget" id="budget" placeholder="Budget" value = "<?php if(isset($fetch_data['Budget_in_INR'])!=NULL && $fetch_data['Budget_in_INR']!=''){echo $fetch_data['Budget_in_INR']; }?>" required="required" style="text-align:left"/>
        <br>
        ...
        <input class = "line" type="text" name="name" id="name" placeholder=" Name" value = "<?php if(isset($fetch_data['Name'])!=NULL && $fetch_data['Name']!=''){echo $fetch_data['Name']; }?>" required="required" style="text-align:left"/>
        
        <!--<br><br>-->
        <label for="email" class="names">Email:</label>
        <input class="line" type="email" name="email" id="email" placeholder="Enter Email" value = "<?php if(isset($fetch_data['Email'])!=NULL && $fetch_data['Email']!=''){echo $fetch_data['Email']; }?>" required="required" style="text-align:left"/>
        
        <br><br><br>
        <label for="country" class="names"> Country:</label>
        <input class = "line" type="text" name="country" id="country" placeholder="Country Name" value = "<?php if(isset($fetch_data['Country'])!=NULL && $fetch_data['Country']!=''){echo $fetch_data['Country']; }?>" required="required" style="text-align:left"/>
        
        <br><br><br>
        <label for="landline" class="names"> Landline No.:</label>
        <input class = "line" type="tel" name="landline" id="landline" placeholder="Landline No." value = "<?php if(isset($fetch_data['Landline'])!=NULL && $fetch_data['Landline']!=''){echo $fetch_data['Landline']; }?>" required="required" style="text-align:left"/>
        

        <label for="mobile" class="names"> Mobile No.:</label>
        <input class = "line" type="tel" name="mobile" id="mobile" placeholder="Mobile" value = "<?php if(isset($fetch_data['Mobile'])!=NULL && $fetch_data['Mobile']!=''){echo $fetch_data['Mobile']; }?>" required="required" style="text-align:left"/>
        
        <br><br><br>
        <label for="address" class="names"> Address:</label>
        <input class = "line" type="text" name="address" id="address" placeholder="Address" value = "<?php if(isset($fetch_data['Address'])!=NULL && $fetch_data['Address']!=''){echo $fetch_data['Address']; }?>" required="required" style="text-align:left; width:30%"/>
    ...
    <form method = "POST" action ="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
          ...
          <br><br>
          <div  class="submit"><input  type ="submit" name="fetch_data" value="Fetch Data"/></div>
    </form>
